...
components: {
	...
	pet_clinic: {
		...
		operations: configure: "./files/petclinic/configure.sh"
	...
	db: {
		...
		operations: configure: "./files/mysql_database/configure.sh"
		relations: [{
			hosted_on: "dbms"
		}]
	}
	...
	dbms: {
		type: "mysql_dbms"
		properties: root_password: "petclinic"
		// operations:
